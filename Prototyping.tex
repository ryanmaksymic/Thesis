...
\begin{figure}
	...
	\hspace{0.1cm}
	\subfloat[Data successfully received from all controllers]{\includegraphics[height=0.32\textwidth]{multi_wii.png}}
...
% Rewrite the first two sentences to make them more useful
...
% State location, name, data, timeframe of exhibition
...
% Reference Bongers here for sure. The magic happens when `reaction' turns into `interaction.'
...
% * The lamps were a communal instrument, `played,' albeit in different ways, by both the audience and the performer. Performers are controlling secondary output (lighting). See what Gates (2006) said about burdensome tech; does lighting become more meaningful when the performer is influencing it? Reference Bongers here for sure.
